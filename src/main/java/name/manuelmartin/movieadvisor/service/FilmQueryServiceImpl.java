...
import name.manuelmartin.movieadvisor.dao.FilmDao;
...
public class FilmQueryServiceImpl implements FilmQueryService {
	...
	public FilmQueryService anyGenre(String... genres) {
		Predicate<Film> pAnyGenre = (film ->Arrays.stream(genres)
	...
	public FilmQueryService allGenres(String... genres) {
		Predicate<Film> pAllGenres = (film ->Arrays.stream(genres)
	...
	public FilmQueryService titleContains(String title) {
		Predicate<Film> pTitleContains = (film -> film.getTitle()
				.toLowerCase()
